		...
		<section class="content">
		  <div class="row">
			...
			<div class="box-header with-border">
			  <h4 class="box-title"> Add Fee</h4>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
			  <div class="row">
				<div class="col">
					<form novalidate method="POST" action="{{ route('fee.category.store')  }} " enctype="multipart/form-data">
                        @csrf
					  <div class="row">
						<div class="col-12">
							...
							<div class="form-group">
                                <h5>Fee Description : <span class="text-danger">*</span></h5>
                                <div class="controls">
