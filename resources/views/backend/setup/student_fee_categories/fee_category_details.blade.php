					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Fee Information</li>
							</ol>
						</nav>
			...
			<div class="col-12">
              ...
              <div class="box box-widget widget-user"><br>
					...
					<div class="widget-user-header bg-black" style="background: url('../images/gallery/full/10.jpg') center center;">
                     <a href="{{ route('fee.category.edit',$detail->id) }}" style="float: right" class="btn btn-rounded btn-success btn-primary  m-5 "> <strong> <i class="fa fa-edit"></i>  Edit  Class  </strong>  </a>
					...
					<div class="widget-user-image">
                        ...
                        <h3 class="text-success"> <strong> Fee Name :  </strong>  </h3>
