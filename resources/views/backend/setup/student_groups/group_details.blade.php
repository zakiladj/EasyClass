	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title">Group {{ $detail->name }} </h3>
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
								<li class="breadcrumb-item" aria-current="page">Tables</li>
								<li class="breadcrumb-item active" aria-current="page">Group Information</li>
							</ol>
						</nav>
                  ...
                  {{-- <button style="float: right" class="btn btn-rounded btn-success mb-5"> <strong> Ajouter Parent <span class="glyphicon glyphicon-plus"></span>  </strong>  </button> --}}
                    <a href="{{ route('student.group.add') }}" class="btn btn-rounded btn-success mb-5 d-flex "> <strong> Ajouter Group <span class="glyphicon glyphicon-plus"></span>  </strong>  </a>
			</div>
			...
			<div class="col-12">
              ...
              <div class="box box-widget widget-user"><br>
					...
					<div class="widget-user-header bg-black" style="background: url('../images/gallery/full/10.jpg') center center;">
                     <a href="{{ route('group.edit',$detail->id) }}" style="float: right" class="btn btn-rounded btn-success btn-primary  m-5 "> <strong> <i class="fa fa-edit"></i>  Edit  Group  </strong>  </a>
					...
					<div class="widget-user-image">
                        ...
                        <h3 class="text-success"> <strong> Group Name :  </strong>  </h3>
