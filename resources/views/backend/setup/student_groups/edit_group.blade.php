					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Ajouter Un Group</li>
							</ol>
						</nav>
		...
		<section class="content">
		  <div class="row">
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
					<form novalidate method="POST" action="{{ route('group.update',$editData->id)  }} " enctype="multipart/form-data">
                        @csrf
					  <div class="row">
						<div class="col-12">
