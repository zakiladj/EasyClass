		...
		<section class="content">
		  <div class="row">
			...
			<div class="box-header with-border">
			  <h4 class="box-title">Ajouter Class</h4>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
			  <div class="row">
				<div class="col">
					<form novalidate method="POST" action="{{ route('class.store')  }} " enctype="multipart/form-data">
                        @csrf
					  <div class="row">
						<div class="col-12">
							...
							<div class="form-group">
								...
								<div class="controls">
									<input type="text" name="grade_level" class="form-control" required data-validation-required-message="This field is required"> </div>
                                    @error('grade_level')
                                            <div class="text-danger"><strong>{{ $message }}</strong> </div>
                                    @enderror
							</div>
							...
							<div class="form-group">
								...
								<div class="controls">
									<input type="text" name="section" class="form-control" required data-validation-required-message="This field is required"> </div>
                                    @error('section')
                                            <div class="text-danger"><strong>{{ $message }}</strong> </div>
                                    @enderror
							</div>
