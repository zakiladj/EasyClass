		...
		<section class="content">
		  <div class="row">
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
					<form novalidate method="POST" action=" {{ route('class.update', $editData->id) }} " enctype="multipart/form-data">
                        @csrf
					  <div class="row">
						<div class="col-12">
							...
							<div class="form-group">
								<h5>Grade Level  :  <span class="text-danger">*</span></h5>
								<div class="controls">
									<input type="text" name="grade_level" value="{{ $editData->grade_level }}" class="form-control" required data-validation-required-message="This field is required"> </div>
                                    @error('grade_level')
                                            <div class="text-danger"><strong>{{ $message }}</strong> </div>
                                    @enderror
							</div>
							...
							<div class="form-group">
								...
								<div class="controls">
									<input type="text" name="section" value="{{ $editData->section }}" class="form-control" required data-validation-required-message="This field is required"> </div>
                                    @error('section')
                                            <div class="text-danger"><strong>{{ $message }}</strong> </div>
                                    @enderror
							</div>
                        	<div class="form-group">
								<h5>NB Student  :  <span class="text-danger">*</span></h5>
								<div class="controls">
									<input type="text" name="nombre" value="{{ $editData->nombre }}" class="form-control" required data-validation-required-message="This field is required"> </div>
                                    @error('nombre')
                                            <div class="text-danger"><strong>{{ $message }}</strong> </div>
                                    @enderror
							</div>
