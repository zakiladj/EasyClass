		...
		<section class="content">
		  <div class="row">
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
					<form novalidate method="POST" action="{{ route('year.store')  }} " enctype="multipart/form-data">
                        @csrf
					  <div class="row">
						<div class="col-12">
							...
							<div class="form-group">
								...
								<div class="controls">
									<input type="number" name="level_order" class="form-control" required data-validation-required-message="This field is required"> </div>
                                    @error('level_order')
                                            <div class="text-danger"><strong>{{ $message }}</strong> </div>
                                    @enderror
							</div>
