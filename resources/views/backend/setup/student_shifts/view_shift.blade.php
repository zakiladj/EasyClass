	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title">Shift Student Class </h3>
			...
			<div class="col-12">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title"> Liste OF student Shift </h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $shift->updated_at }}</td>
                                 <td> <a href=" {{ route('shift.details',$shift->id) }}" class="btn btn-sm btn-info"> <strong> Information  <span class="glyphicon glyphicon-info-sign"></span> </strong> </a>  </td>
                                 <td> <a href="{{ route('shift.edit',$shift->id) }}" class="btn btn-sm btn-warning"> <strong> Update <span class="glyphicon glyphicon-pencil"></span>  </strong></a> </td>
                                 <td> <a href="{{ route('shift.delete',$shift->id) }}" class="btn btn-sm btn-danger" > Delete <span class="glyphicon glyphicon-remove"></span> </a> </td>
