		...
		<section class="content">
		  <div class="row">
			...
			<div class="box-header with-border">
			  <h4 class="box-title">Ajouter Shift Student</h4>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
			  <div class="row">
				<div class="col">
					<form novalidate method="POST" action="{{ route('shift.update',$editData->id)  }} " enctype="multipart/form-data">
                        @csrf
					  <div class="row">
						<div class="col-12">
							...
							<div class="form-group">
                             ...
                             <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="time" name="start_time" value="{{ $editData->start_time }}" class="form-control timepicker" required data-validation-required-message="This field is required">
                                        </div>
                                        @error('start_time')
                                            <div class="text-danger"><strong>{{ $message }}</strong></div>
                                        @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="time" name="end_time" value="{{ $editData->end_time }}"  class="form-control timepicker" required data-validation-required-message="This field is required">
                                </div>
                                @error('end_time')
                                    <div class="text-danger"><strong>{{ $message }}</strong></div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" id="select" value="{{ $editData->status }}" required="" class="form-control" aria-invalid="false">
