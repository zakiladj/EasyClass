    ...
    <div class="col-12">
      <div class="box">
        ...
        <div class="mb-15 d-flex align-items-center">
                <a href="{{ route('enfant.chart.js', ['preset' => 'today']) }}" class="btn btn-warning">اليوم</a>
                <a href="{{ route('enfant.chart.js', ['preset' => 'week']) }}" class="btn btn-primary ml-5">هذا الأسبوع</a>
                <a href="{{ route('enfant.chart.js', ['preset' => 'month']) }}" class="btn btn-info ml-5">هذا الشهر</a>
                <a href="{{ route('enfant.chart.js', ['preset' => 'year']) }}" class="btn btn-success ml-5">هذه السنة</a>

                {{-- يدز زر الطباعة لليمين --}}
                <a href="{{ route('enfant.chart.print', request()->query()) }}"
                    class="btn btn-link ml-auto"
                    title="طباعة">
                    <i class="mdi mdi-printer"></i>طباعة
                </a>
        </div>
            <form method="GET" id="rangeForm" action="{{ route('enfant.chart.js') }}"  class="row g-2 mb-20 no-validate">
